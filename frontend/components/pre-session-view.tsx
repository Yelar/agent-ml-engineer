...
export function PreSessionView({
  ...
  return (
    <div className="flex h-screen flex-col bg-background">
        ...
        {messages.length === 0 ? (
          <div className="mx-auto flex h-full max-w-2xl flex-col items-center justify-center text-center">
            ...
            <p className="mt-3 max-w-md text-sm text-muted-foreground">
              Attach one or more CSV files, ask a question, and the notebook
              workspace will come alive with insights.
            </p>
          </div>
        ) : (
      ...
      <form
        className="border-t border-border bg-background px-8 py-6"
      ...
      >
        ...
        <div className="mt-3 flex items-center justify-between text-xs text-muted-foreground">
          ...
          {isSending ? (
            <span className="text-primary">Generating insights…</span>
          ) : null}
        </div>
      </form>
    </div>
